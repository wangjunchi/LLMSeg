...
class VQADataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        # sam mask reader
        self.sam_mask_helper = coco2017_sam_mask_helper
        assert self.sam_mask_helper is not None
    ...
    def __getitem__(self, idx):
        ...
        # read sam seg
        segs_dict = self.sam_mask_helper.extract_sam_segs(item["image"])
        ...
        ious = torch.rand((0, segs_origin.shape[-1]))
        iops = torch.rand((0, segs_origin.shape[-1]))
