...
parser.add_argument("--input_path", type=str, default="/cluster/scratch/leikel/junchi/lisa_dataset/mapillary/training/images",
                     help="path to coco dataset")
parser.add_argument("--output_path", type=str, default="/cluster/home/leikel/junchi/processed_data/mapillary", 
