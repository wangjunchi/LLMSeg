...
parser.add_argument("--input_path", type=str, default="/cluster/scratch/leikel/junchi/lisa_dataset/vlpart/pascal_part/VOCdevkit/VOC2010/JPEGImages",
                     help="path to coco dataset")
parser.add_argument("--output_path", type=str, default="/cluster/home/leikel/junchi/processed_data/voc2010", 
